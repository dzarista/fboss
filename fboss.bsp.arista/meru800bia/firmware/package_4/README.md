...
| Programmable Name                                                            | Description                                                            |
|------------------------------------------------------------------------------|------------------------------------------------------------------------|
| P_meru800bia_F_smb_fpga_V_4.18.abit                                          | No software-visible change vs 4.17.                                    |
| P_meru800bia_F_fan_cpld_V_1.10.astp                                          | No software-visible change vs 1.9.                                     |
...
| 4.17    | Reduced the drive strength of PORT I2C buses - BUG1135569          |
| 4.18    | No software-visible change vs 4.17.                                |
