...
static inline int scd_smbus_cs_fsz(union smbus_ctrl_status_reg cs)
{
...
#define CS_ARGS(_cs)                                                           \
	(_cs).reg, (_cs).rst, (_cs).fe, (_cs).ver, (_cs).brb, (_cs).nrq,       \
		(_cs).sp, (_cs).foe, (_cs).fsz, (_cs).nrs
...
#define REQ_ARGS(_req)                                                         \
	(_req).reg, (_req).ti, (_req).bs, (_req).st, (_req).dod, (_req).da,    \
		(_req).sp, (_req).t, (_req).dat, (_req).br, (_req).ed,         \
		(_req).ss, (_req).d
...
#define RSP_ARGS(_rsp)                                                         \
	(_rsp).reg, (_rsp).fe, (_rsp).foe, (_rsp).ss, (_rsp).ti,               \
		(_rsp).flushed, (_rsp).ack_error, (_rsp).timeout_error,        \
		(_rsp).bus_conflict_error, (_rsp).d
