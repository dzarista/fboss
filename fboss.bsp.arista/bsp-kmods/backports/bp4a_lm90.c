...
static const struct i2c_device_id bp4a_lm90_id[] = {
	{ "bp4a_tmp451", tmp451 },
	{ "bp4a_max6658", max6657 },
	{ }
};
MODULE_DEVICE_TABLE(i2c, bp4a_lm90_id);

static const struct of_device_id __maybe_unused bp4a_lm90_of_match[] = {
	{
		.compatible = "bp4a,max6658",
		.data = (void *)max6657
	},
	{
		.compatible = "bp4a,tmp451",
		.data = (void *)tmp451
	},
	{ },
};
MODULE_DEVICE_TABLE(of, bp4a_lm90_of_match);
...
static int lm90_probe(struct i2c_client *client)
{
	...
	/*
	 * XXX ignore devm_regulator_get_enable() failure because
	 * CONFIG_REGULATOR is not enabled in fbkernel yet.
	 */
	devm_regulator_get_enable(dev, "vcc");
	...
	if (client->dev.of_node)
		...
		data->kind = i2c_match_id(bp4a_lm90_id, client)->driver_data;
...
static struct i2c_driver bp4a_lm90_driver = {
	.class		= I2C_CLASS_HWMON,
	.driver = {
		.name	= "bp4a_lm90",
		.of_match_table = of_match_ptr(bp4a_lm90_of_match),
		.pm	= pm_sleep_ptr(&lm90_pm_ops),
	},
	.probe		= lm90_probe,
	.alert		= lm90_alert,
	.id_table	= bp4a_lm90_id,
	.detect		= lm90_detect,
	.address_list	= normal_i2c,
};

module_i2c_driver(bp4a_lm90_driver);
