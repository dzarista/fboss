...
static const struct of_device_id bp4a_max1363_of_match[] = {
	MAX1363_COMPATIBLE("bp4a,max11645", max11645),
	{ /* sentinel */ }
};
MODULE_DEVICE_TABLE(of, bp4a_max1363_of_match);
...
static int max1363_probe(struct i2c_client *client)
{
	 ...
	 */
	devm_regulator_get_enable(&client->dev, "vcc");
...
static const struct i2c_device_id bp4a_max1363_id[] = {
	{ "bp4a_max11645", max11645 },
	{}
};

MODULE_DEVICE_TABLE(i2c, bp4a_max1363_id);

static struct i2c_driver bp4a_max1363_driver = {
	.driver = {
		.name = "bp4a_max1363",
