Name: arista-fboss-platform-glath06l-64or
Version: 1
Release: 1%{?dist}
Summary: Arista FBOSS OSS glath06l-64or Platform Utilities
Requires: arista-fboss-core

License: GPLv2
URL: https://github.com/aristanetworks/arista-fboss

%define _fboss_glath06l_64or_dir %{_fboss_dir}/arista/platform/glath06l-64or
%define _fboss_config_dir %{_fboss_dir}/fboss/platform/configs
%define _fboss_fw_dir %{_fboss_dir}/fboss.bsp.arista/glath06l-64or/firmware
...
glath06l-64or (Steamerlane) switches.

%install
mkdir -p %{_fboss_target_share}

mkdir -p %{_fboss_target_var}
install %{_fboss_glath06l_64or_dir}/config/fruid/fruid.json %{_fboss_target_var}

mkdir -p %{_fboss_target_share}/platform_configs
# cp -rf %{_fboss_config_dir}/glath06l-64or/* %{_fboss_target_share}/platform_configs/
