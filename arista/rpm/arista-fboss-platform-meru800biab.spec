...
%define _link_test_configs %{_fboss_target_share}/link_test_configs
%define _hw_test_configs %{_fboss_target_share}/hw_test_configs
%define _qsfp_test_configs %{_fboss_target_share}/qsfp_test_configs
...
cp -af %{SOURCEURL0}/%{_fboss_oss_dir}/link_test_configs/meru800bia.materialized_JSON config_files/
cp -af %{SOURCEURL0}/%{_fboss_oss_dir}/hw_test_configs/meru800bia.agent.materialized_JSON config_files/
cp -af %{SOURCEURL0}/%{_fboss_oss_dir}/qsfp_test_configs/meru800bia.materialized_JSON config_files/
...
# Copy the platform configs and rename them to meru800bia
mkdir -p %{_link_test_configs}
mkdir -p %{_hw_test_configs}
mkdir -p %{_qsfp_test_configs}
...
/opt/fboss/share/hw_test_configs/meru800biab.agent.materialized_JSON
/opt/fboss/share/link_test_configs/meru800biab.materialized_JSON
/opt/fboss/share/qsfp_test_configs/meru800biab.materialized_JSON
