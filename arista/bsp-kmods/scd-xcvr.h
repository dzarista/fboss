...
#define SCD_XCVR_ATTR(_xcvr_attr, _name, _name_size, _mode, _show, _store,     \
		      _xcvr, _bit, _active_low, _clear_on_read)                \
	do {                                                                   \
		snprintf(_xcvr_attr.name, _name_size, _name);                  \
		_xcvr_attr.dev_attr =                                          \
			(struct device_attribute)__ATTR_NAME_PTR(              \
				_xcvr_attr.name, _mode, _show, _store);        \
...
#define SCD_RO_XCVR_ATTR(_xcvr_attr, _name, _name_size, _xcvr, _bit,           \
			 _active_low, _clear_on_read)                          \
	SCD_XCVR_ATTR(_xcvr_attr, _name, _name_size, S_IRUGO,                  \
		      attribute_xcvr_get, NULL, _xcvr, _bit, _active_low,      \
		      _clear_on_read)
