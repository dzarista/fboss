...
class StaticMapping( DataClassWithFieldGetter ):
   ...
   # Y/N string, is polarity swapped for tx trace.
   A_TX_POLARITY_SWAP: str
   # Y/N string, is polarity swapped for rx trace.
...
@dataclass
class ProfileSettings( DataClassWithFieldGetter ):
    Port_Speed_mbps: int = field(metadata={"label": "Port_Speed(mbps)"})
    A_CHIP_TYPE: str
    Z_CHIP_TYPE: str
    NUM_LANES: int
    Modulation: str
