...
## Usage
create_live_image.sh <kernel version> <centos stream number>.
Pass the kernel version and CentOS stream used for building the live image as arguments.
...
create_live_image.sh runs docker_script.shwith the logic to create the live image inside a CentOS container.
