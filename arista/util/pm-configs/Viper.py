...
class Viper:
   ...
   SYMBOLIC_LINK_TO_DEVICE_PATH = {
      ...
      **generateSensorSymlinks( EMBEDDED_SENSORS_CONFIGS, I2C_DEVICE_CONFIGS, "SCM" ),
      ...
      **generateSensorSymlinks( EMBEDDED_SENSORS_CONFIGS, I2C_DEVICE_CONFIGS, "SMB" ),
      ...
      **generateXcvrSymlinks( XCVR_CONFIGS[ "SMB_FPGA" ] ),
